...
const SECTION_TITLE_TO_TEXT = {
  'Exhibit ownership': `I try to always think like an owner. "How can I make this better?" I believe if everyone feels ownership, the resulting product will excell.`,

  'Be pragmatic': `I generally don't believe in absolutes when it comes to development. Beyond a few language-independant universal truths, 'best practice' is something that usually depends on the context of a problem.`,
